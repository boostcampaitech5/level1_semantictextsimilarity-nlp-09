...
def base_train(train_config, folder_name):
    ...
    model_checkpoint = ModelCheckpoint(dirpath=train_config.folder_dir, save_top_k=1, monitor="val_pearson", mode=callback_setting[train_config.callback]["mode"], filename="best")
