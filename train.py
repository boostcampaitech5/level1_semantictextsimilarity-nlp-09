...
def base_train(train_config, sweep_config, logger):
    ...
    trainer = pl.Trainer(accelerator='gpu', max_epochs=train_config.max_epoch, log_every_n_steps=1, logger=logger, callbacks = [early_stopping], default_root_dir=train_config.folder_dir)
